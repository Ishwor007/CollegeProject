...
public class RForm extends JFrame {
	...
	public RForm() {
		...
		contentPane.add(getLblRegistrationForm());
	...
	private JLabel getLblRegistrationForm() {
		if (lblRegistrationForm == null) {
			lblRegistrationForm = new JLabel("REGISTRATION FORM");
			lblRegistrationForm.setFont(new Font("Dialog", Font.BOLD, 20));
			lblRegistrationForm.setBounds(174, 12, 248, 24);
		}
		return lblRegistrationForm;
	}
	private JSeparator getSeparator() {
		if (separator == null) {
			separator = new JSeparator();
			separator.setForeground(Color.PINK);
			separator.setBounds(155, 34, 267, 2);
		}
		return separator;
	}
	...
	private JButton getBtnReset() {
		if (btnReset == null) {
			...
			btnReset.setBounds(133, 285, 117, 25);
		}
		return btnReset;
	}
	private JButton getBtnSubmit() {
		if (btnSubmit == null) {
			...
			btnSubmit.setBounds(305, 285, 117, 25);
		}
		return btnSubmit;
	}
